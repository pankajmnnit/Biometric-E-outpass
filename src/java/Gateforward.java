 ...
 * @author JOSHI
 */
public class Gateforward extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       ResultSet rs=stmt.executeQuery("Select password,ID from hostel.gate"); 
       ...
       while(rs.next()){
          ...
          if((pwd.equals(pass)) && (coer_id==id))
          {
           ...
           RequestDispatcher view = request.getRequestDispatcher("gate_dashboard.html");
...
"			<font color='white'>	Something went wrong please try again "
                     ...
                     "<h3><a href=\"gatelogin.html\"  class=\"wooo\"><p>Retry</p></a></h2>"+
